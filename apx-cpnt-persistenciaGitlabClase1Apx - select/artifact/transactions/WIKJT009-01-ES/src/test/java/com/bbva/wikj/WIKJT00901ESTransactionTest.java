...
/**
 * Test for transaction WIKJT00901ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT00901ESTest.xml" })
public class WIKJT00901ESTransactionTest {

	@Autowired
	private WIKJT00901ESTransaction transaction;
